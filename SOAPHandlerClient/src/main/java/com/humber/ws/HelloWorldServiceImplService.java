 ...
 * 
 */
@WebServiceClient(name = "HelloWorldServiceImplService", targetNamespace = "http://ws.humber.com/", wsdlLocation = "http://localhost:8080/ws/soapHandler?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICEIMPLSERVICE_QNAME = new QName("http://ws.humber.com/", "HelloWorldServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ws/soapHandler?wsdl");
    ...
    public HelloWorldService getHelloWorldServiceImplPort() {
        return super.getPort(new QName("http://ws.humber.com/", "HelloWorldServiceImplPort"), HelloWorldService.class);
    }
    ...
    public HelloWorldService getHelloWorldServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.humber.com/", "HelloWorldServiceImplPort"), HelloWorldService.class, features);
    }
