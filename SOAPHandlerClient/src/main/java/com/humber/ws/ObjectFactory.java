 ...
 * generated in the com.humber.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorld_QNAME = new QName("http://ws.humber.com/", "sayHelloWorld");
    private final static QName _SayHelloWorldResponse_QNAME = new QName("http://ws.humber.com/", "sayHelloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.humber.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.humber.com/", name = "sayHelloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.humber.com/", name = "sayHelloWorldResponse")
